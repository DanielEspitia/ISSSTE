...
<div id="contentRight">
	...
	<ul class="menu">
		<li class="item-563 primera"><a class="tooltip_arriba" href="/index.php/afiliacion-vigencia">Afiliación y Vigencia de derechos</a></li>
        <li class="item-564"><a class="tooltip_arriba" href="/index.php/trabajador-pensionado">Trabajadores y Extrabajadores</a></li>
        <li class="item-565"><a class="tooltip_arriba" href="/index.php/requisitos-inscripcion">Requisitos para la inscripción de derechohabientes</a></li>
        <li class="item-566"><a class="ext tooltip_arriba" href="http://oficinavirtual.issste.gob.mx/" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,');return false;">Mi oficina virtual</a></li>
