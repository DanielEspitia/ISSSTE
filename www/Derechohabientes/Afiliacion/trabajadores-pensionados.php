  ...
  <table class="table table-striped table-hover ">
                <tbody>
                  <tr>
                    ...
                    <p>Así mismo, podrá acudir  al área  de  Recursos  Humanos de su Dependencia o Entidad y solicitar copia del "Aviso de Alta de Trabajador" ante el ISSSTE (Ley del ISSSTE, Artículo 7).</p>
...
<tr>
                    ...
                    <ul type="disc">
                       ...
                       <li>Con hijo(a) procreado(a), adoptado(a) o reconocido(a)</li>
                       <li>Sin hijo(a).</li>
                       <li>Hijos:</li>
                             <ul type="circle">
                             <li>Hijo(a) menor de 18 años de edad.</li>
                             <li>Hijo(a) soltero(a) estudiante de nivel medio superior, mayor de 18 años y hasta  cumplir 26 años.</li>
                             <li>Hijo(a) incapacitado(a) física o psíquicamente mayor de 18 años de edad.</li>
                             </ul>
                      <li>Ascendientes:</li>
                            <ul type="circle">
                ...
                <tbody>
                  <tr align="center">
                    <td colspan="2" id="centrar"><b>Requisitos</b></td>
                  </tr>
...
<tr>
                    ...
                    <p><b>Pensionado</b></p>
                    <p>La Subdirección de Pensiones realizará su registro.</p>
                   ...
                   <li>Comprobante del domicilio actual de no más de tres meses:</li>
                         <ul type="circle">
                         <li>Recibo de energía eléctrica (Luz)</li>
                         <li>Recibo de teléfono</li>
                         <li>Estado de cuenta bancaria o comercial</li>
                         <li>Contrato de arrendamiento</li>
                         <li>Predial</li>                         
                         </ul>
                   <li>Identificación oficial:</li>
                          <ul type="circle">
                          <li>Credencial del IFE</li>
